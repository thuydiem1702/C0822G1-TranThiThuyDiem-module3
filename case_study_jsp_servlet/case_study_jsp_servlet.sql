...
insert into employee(employee_name, employee_day_of_birth, employee_id_card, employee_salary, employee_phone_number, employee_email, employee_address, position_id, education_degree_id, division_id)
values
...
insert into customer(customer_name, customer_day_of_birth, customer_gender, customer_id_card, customer_phone_number, customer_email, customer_address, customer_type_id)
values
