            ...
            <div class="collapse navbar-collapse container-fluid" id="navbarNavAltMarkup">
                ...
                <div class="navbar-nav col-lg-8">
                    ...
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-close-white">
                            <a href="https://github.com/thuydiem1702/C0822G1-TranThiThuyDiem-module3/tree/main/case_study_jsp_servlet">Employee</a>
                        </button>
                    </div>
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-close-white">
                    ...
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-close-white">
                            <a href="https://github.com/thuydiem1702/C0822G1-TranThiThuyDiem-module3/tree/main/case_study_jsp_servlet">Service</a>
                        </button>
                    </div>
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-close-white">
                            <a href="https://github.com/thuydiem1702/C0822G1-TranThiThuyDiem-module3/tree/main/case_study_jsp_servlet">Contract</a>
                        </button>
                    </div>
                </div>
                <div class="col-lg-3">
