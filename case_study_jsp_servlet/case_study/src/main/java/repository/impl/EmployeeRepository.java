...
public class EmployeeRepository implements IEmployeeRepository {
    ...
    private static final String INSERT = "insert into employee(employee_name, employee_day_of_birth, employee_id_card, " +
            "employee_salary, employee_phone_number, employee_email, employee_address, position_id, education_degree_id, " +
            "division_id) values(?,?,?,?,?,?,?,?,?,?);";
    private static final String FIND_BY_ID = "select * from employee where employee_id = ? and is_delete = 0;";
    private static final String UPDATE = "update employee set employee_name = ?, employee_day_of_birth = ?, " +
            "employee_id_card = ?, employee_salary = ?, employee_phone_number = ?, employee_email = ?, " +
